...
class MLP(nn.Module):
    def __init__(self, nin, nout, nlayer=2, dropout=0.0, with_final_activation=True, with_norm=BN, bias=True):
        super().__init__()
        n_hid = nin
        ...
        self.dropout = nn.ModuleList([nn.Dropout(dropout) for i in range(nlayer)])
